 ...
 *
 */
abstract class BasePostRepository<E : Any, T, X : Any, V, K : Any> : BaseRemoteApiRepository<E, T, X, V>
    ...
    protected abstract fun getApiList(api: V, objDto: K, onResponse: (BaseResponse<List<X>>) -> Unit, onFailure: (t: Throwable) -> Unit)
    protected abstract fun getObjApiDto(api: V, objDto: K, onResponse: (BaseResponse<X>) -> Unit, onFailure: (t: Throwable) -> Unit)
